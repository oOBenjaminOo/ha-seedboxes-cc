...
SENSORS: tuple[SeedboxSensorEntityDescription, ...] = (
    ...
    SeedboxSensorEntityDescription(key="monthly_traffic", translation_key="monthly_traffic", data_key=NAME_MONTHLY_TRAFFIC, native_unit_of_measurement=UnitOfInformation.GIGABYTES, device_class=SensorDeviceClass.DATA_SIZE, icon="mdi:upload-network"),
